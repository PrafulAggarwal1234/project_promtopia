...
const PromptCard = ({post,handleTagClick,handleEdit,handleDelete}) => {
  ...
  return (
    <div className="prompt_card">
      <div className="flex jusitfy-between items-start gap-5">
        <div className="flex-1 flex justify-start items-center gap-3 cursor-pointer" onClick={()=> handleProfileClick(post.creator._id)}>
          <Image
      ...
      <p className="my-4 font-satoshi text-sm temp-gray-700">{post.prompt}</p>
